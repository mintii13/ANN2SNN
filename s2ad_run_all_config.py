...
BASE_SAVE_DIR = './s2ad_results_config'
...
backbone_configs = [
    ...
    {'layers': 'layer2',   'use_membrane': False, 'calib_samples': 500, 'batch_size': 16, 'name': 'backbone_layer2_memFalse'},
    {'layers': 'layer3',   'use_membrane': False, 'calib_samples': 500, 'batch_size': 16, 'name': 'backbone_layer3_memFalse'},
]

# ========== NHÓM 2: Kiểm tra membrane effect ==========
# membrane=True, calib=500
membrane_configs = [
    {'layers': 'layer123', 'use_membrane': True, 'calib_samples': 500, 'batch_size': 16, 'name': 'membrane_layer123_memTrue'},
    {'layers': 'layer23',  'use_membrane': True, 'calib_samples': 500, 'batch_size': 16, 'name': 'membrane_layer23_memTrue'},
    {'layers': 'layer2',   'use_membrane': True, 'calib_samples': 500, 'batch_size': 16, 'name': 'membrane_layer2_memTrue'},
    {'layers': 'layer3',   'use_membrane': True, 'calib_samples': 500, 'batch_size': 16, 'name': 'membrane_layer3_memTrue'},
]

# ========== NHÓM 3: Kiểm tra calibration samples ==========
calib_configs = [
    # calib=50
    {'layers': 'layer123', 'use_membrane': True,  'calib_samples': 50, 'batch_size': 16, 'name': 'calib50_layer123_memTrue'},
    {'layers': 'layer23',  'use_membrane': True,  'calib_samples': 50, 'batch_size': 16, 'name': 'calib50_layer23_memTrue'},
    ...
    # calib=100
    {'layers': 'layer123', 'use_membrane': True,  'calib_samples': 100, 'batch_size': 16, 'name': 'calib100_layer123_memTrue'},
    {'layers': 'layer23',  'use_membrane': True,  'calib_samples': 100, 'batch_size': 16, 'name': 'calib100_layer23_memTrue'},
...
# ========== NHÓM 4: Kiểm tra batch size ==========
batch_configs = [
    # batch_size=8
    {'layers': 'layer123', 'use_membrane': True,  'calib_samples': 500, 'batch_size': 8, 'name': 'batch8_layer123_memTrue'},
    {'layers': 'layer23',  'use_membrane': True,  'calib_samples': 500, 'batch_size': 8, 'name': 'batch8_layer23_memTrue'},
    {'layers': 'layer123', 'use_membrane': False, 'calib_samples': 500, 'batch_size': 8, 'name': 'batch8_layer123_memFalse'},
    {'layers': 'layer23',  'use_membrane': False, 'calib_samples': 500, 'batch_size': 8, 'name': 'batch8_layer23_memFalse'},
    # batch_size=32
    {'layers': 'layer123', 'use_membrane': True,  'calib_samples': 500, 'batch_size': 32, 'name': 'batch32_layer123_memTrue'},
    {'layers': 'layer23',  'use_membrane': True,  'calib_samples': 500, 'batch_size': 32, 'name': 'batch32_layer23_memTrue'},
    {'layers': 'layer123', 'use_membrane': False, 'calib_samples': 500, 'batch_size': 32, 'name': 'batch32_layer123_memFalse'},
    {'layers': 'layer23',  'use_membrane': False, 'calib_samples': 500, 'batch_size': 32, 'name': 'batch32_layer23_memFalse'},
]

# Gộp tất cả configs
ALL_CONFIGS = backbone_configs + membrane_configs + calib_configs + batch_configs
...
def main():
    ...
    if 'membrane' in config_groups or 'all' in config_groups:
        selected_configs.extend(membrane_configs)
    if 'calib' in config_groups or 'all' in config_groups:
        selected_configs.extend(calib_configs)
    if 'batch' in config_groups or 'all' in config_groups:
        selected_configs.extend(batch_configs)
